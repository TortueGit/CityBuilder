...
public:
	...
	sf::Color textBodyCol;
	sf::Color textBorderCol;
	sf::Color textHighlightBodyCol;
	sf::Color textHighlightBorderCol;
	sf::Font* font;

	float borderSize;

	GuiStyle(sf::Font* font, float borderSize,
		sf::Color bodyCol, sf::Color borderCol, 
		sf::Color textBodyCol, sf::Color textBorderCol,
		sf::Color bodyHighlightCol, sf::Color borderHighlightCol, 
		sf::Color textHighlightBodyCol, sf::Color textHighlightBorderCol)
	{
		this->font = font;
		this->borderSize = borderSize;
		this->bodyCol = bodyCol;
		this->borderCol = borderCol;
		this->textBodyCol = textBodyCol;
		this->textBorderCol = textBorderCol;
		this->bodyHighlightCol = bodyHighlightCol;
		this->borderHighlightCol = borderHighlightCol;
		this->textHighlightBodyCol = textHighlightBodyCol;
		this->textHighlightBorderCol = textHighlightBorderCol;
	}
	GuiStyle() { }
};
...
public:
		...
		GuiStyle& style, std::vector<std::pair<std::string, std::string>> entries)
	{
		...
		for (auto entry : entries)
		{
			...
			text.setFillColor(style.textBodyCol);
			text.setOutlineColor(style.textBorderCol);
	...
	* -1 if the mouse is outside of the Gui */
	...
	/* Return the message vound to the entry. */
